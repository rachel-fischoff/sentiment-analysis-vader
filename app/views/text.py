...
def return_words ():
    ...
    with open ('/Users/rachel/Desktop/Code/sentiment-analysis/app/views/text.txt', 'r') as infile:
        ...
        #write ngrams to csv
        with open ('/Users/rachel/Desktop/Code/sentiment-analysis/app/views/ngram_vader.csv', mode='w', newline='') as csv_file:
            fieldnames = ['ngrams']
        ...
        df = pd.read_csv('/Users/rachel/Desktop/Code/sentiment-analysis/app/views/ngram_vader.csv')
        ...
        df = df.to_csv(r'/Users/rachel/Desktop/Code/sentiment-analysis/app/views/ngram_vader.csv', index = False, header=True)
...
def return_ngrams():
    #use pandas to read the csv
    df = pd.read_csv('/Users/rachel/Desktop/Code/sentiment-analysis/app/views/ngram_vader.csv', engine='python')
